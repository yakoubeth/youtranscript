  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-blue-900/20 to-purple-900/20 text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-72 h-72 bg-blue-400/5 rounded-full blur-3xl"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full border-2 border-gray-900 shadow-sm animate-pulse"></div>
              </div>
              <div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-white via-blue-200 to-purple-200 bg-clip-text text-transparent">
                  YouTranscript
                </h3>
                <p className="text-gray-300 text-sm font-medium">AI-Powered YouTube Transcription</p>
              </div>
            </div>
            ...
            <p className="text-gray-300 mb-8 max-w-lg text-lg leading-relaxed">
              ...
              <span className="text-blue-300 font-medium">Start your 14-day free trial</span> and join thousands of creators saving hours every week.
            </p>
            ...
            <div className="flex space-x-4">
              <a 
                ...
                aria-label="Twitter"
              >
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-blue-600/20 to-purple-600/20 backdrop-blur-sm rounded-2xl p-6 border border-blue-500/20">
              ...
              <p className="text-gray-300 text-sm mb-4">Start your free trial today and transform your content workflow.</p>
              <Link href="/signup">
                <button className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-xl">
                  Start Free Trial
                </button>
              </Link>
            </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/privacy" className="text-gray-400 hover:text-blue-300 text-sm transition-colors duration-200">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-gray-400 hover:text-blue-300 text-sm transition-colors duration-200">
              Terms of Service
            </Link>
          </div>
        </div>
