        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              ...
              <Link href="/" className="flex items-center ml-4 md:ml-0 group">
                <div className="relative">
                  <div className="w-10 h-10 bg-red-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                    <svg 
          ...
          <div className="h-full px-3 py-4 overflow-y-auto">
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center px-3 py-2 text-sm font-medium rounded-lg text-gray-700 hover:text-red-700 hover:bg-red-50 dark:text-gray-300 dark:hover:text-red-200 dark:hover:bg-red-900/10 transition-colors"
              >
                {icons.play}
